...
void
L2Cache_Controller::a_issueFetchToMemory(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    (*out_msg).m_ThreadId = ((*in_msg_ptr)).m_ThreadId;
...
void
L2Cache_Controller::b_forwardRequestToExclusive(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:471: %s.\n", "assert failure");
...
void
L2Cache_Controller::c_exclusiveReplacement(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:484: %s.\n", "assert failure");
...
void
L2Cache_Controller::c_exclusiveCleanReplacement(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
/** \brief Send data to memory */
void
L2Cache_Controller::ct_exclusiveReplacementFromTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:510: %s.\n", "assert failure");
...
void
L2Cache_Controller::d_sendDataToRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:524: %s.\n", "assert failure");
...
/** \brief Send data from cache to reqeustor */
void
L2Cache_Controller::dd_sendExclusiveDataToRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
/** \brief Send data from cache to reqeustor */
void
L2Cache_Controller::ds_sendSharedDataToRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:562: %s.\n", "assert failure");
...
void
L2Cache_Controller::e_sendDataToGetSRequestors(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing e_sendDataToGetSRequestors\n");
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:575: %s.\n", "assert failure");
...
if (!(((((*m_tbe_ptr).m_L1_GetS_IDs).count()) > (0)))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:576: %s.\n", "assert failure");
...
;
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:578: %s.\n", "assert failure");
...
/** \brief Send data from cache to all GetS IDs */
void
L2Cache_Controller::ex_sendExclusiveDataToGetSRequestors(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing ex_sendExclusiveDataToGetSRequestors\n");
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:589: %s.\n", "assert failure");
...
if (!(((((*m_tbe_ptr).m_L1_GetS_IDs).count()) == (1)))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:590: %s.\n", "assert failure");
...
;
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:592: %s.\n", "assert failure");
...
void
L2Cache_Controller::ee_sendDataToGetXRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:604: %s.\n", "assert failure");
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:605: %s.\n", "assert failure");
    ...
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:610: %s\n", (*out_msg).m_Destination);
    (*out_msg).m_DataBlk = (*m_cache_entry_ptr).m_DataBlk;
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:612: Address: %#x, Destination: %s, DataBlock: %s\n", (*out_msg).m_addr, (*out_msg).m_Destination, (*out_msg).m_DataBlk);
    (*out_msg).m_MessageSize = MessageSizeType_Response_Data;
    ((*m_responseFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l1_latency)));
}
...
void
L2Cache_Controller::f_sendInvToSharers(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:620: %s.\n", "assert failure");
...
void
L2Cache_Controller::fw_sendFwdInvToSharers(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:633: %s.\n", "assert failure");
...
void
L2Cache_Controller::fwm_sendFwdInvToSharersMinusRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:646: %s.\n", "assert failure");
...
void
L2Cache_Controller::i_allocateTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing i_allocateTBE\n");
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:660: %s.\n", "assert failure");
...
void
L2Cache_Controller::s_deallocateTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::jj_popL1RequestQueue(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::k_popUnblockQueue(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::o_popIncomingResponseQueue(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::m_writeDataToCache(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:691: %s.\n", "assert failure");
...
/** \brief Write data from response queue to cache */
void
L2Cache_Controller::mr_writeDataToCacheFromRequest(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:701: %s.\n", "assert failure");
...
void
L2Cache_Controller::q_updateAck(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:711: %s.\n", "assert failure");
...
void
L2Cache_Controller::qq_writeDataToTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:721: %s.\n", "assert failure");
...
void
L2Cache_Controller::ss_recordGetSL1ID(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:729: %s.\n", "assert failure");
...
void
L2Cache_Controller::xx_recordGetXL1ID(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:736: %s.\n", "assert failure");
...
void
L2Cache_Controller::set_setMRU(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::qq_allocateL2CacheBlock(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing qq_allocateL2CacheBlock\n");
    try {
           if ((m_cache_entry_ptr == NULL)) {
        set_cache_entry(m_cache_entry_ptr, (((*m_L2cache_ptr)).allocate(addr, new L2Cache_Entry, core_id)));;
    }
...
void
L2Cache_Controller::rr_deallocateL2CacheBlock(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing rr_deallocateL2CacheBlock\n");
    try {
           if ((((*m_L2cache_ptr)).getTrigger(addr, core_id))) {
        DPRINTF(WayEvictMICRO17, "MESI_Two_Level-L2cache.sm:753: triggered: %#x\n", addr);
        {
            std::shared_ptr<RequestMsg> out_msg = std::make_shared<RequestMsg>(clockEdge());
            (*out_msg).m_addr = addr;
            (*out_msg).m_Type = CoherenceRequestType_EVI_NOTI;
            (*out_msg).m_Requestor = m_machineID;
            (*out_msg).m_Destination = (*m_cache_entry_ptr).m_PriorSharers;
            (*out_msg).m_MessageSize = MessageSizeType_Request_Control;
            ((*m_L1RequestFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles((1))));
        }
    }
    (((*m_L2cache_ptr)).deallocate(addr, core_id));
...
void
L2Cache_Controller::t_sendWBAck(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::ts_sendInvAckToUpgrader(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:784: %s.\n", "assert failure");
...
void
L2Cache_Controller::uu_profileMiss(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing uu_profileMiss\n");
    try {
       (++ ((*m_L2cache_ptr)).m_demand_misses);
DPRINTF(MTRACEMICRO17, "MESI_Two_Level-L2cache.sm:798: Time:%lld, Addr: %#x\n", (curCycle()), addr);
...
void
L2Cache_Controller::uu_profileHit(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing uu_profileHit\n");
    try {
       (++ ((*m_L2cache_ptr)).m_demand_hits);
DPRINTF(MTRACEMICRO17, "MESI_Two_Level-L2cache.sm:803: Time:%lld, Addr: %#x\n", (curCycle()), addr);
...
void
L2Cache_Controller::nn_addSharer(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:808: %s.\n", "assert failure");
...
/** \brief Add L1 sharer to list */
void
L2Cache_Controller::nnu_addSharerFromUnblock(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:816: %s.\n", "assert failure");
...
void
L2Cache_Controller::kk_removeRequestSharer(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:823: %s.\n", "assert failure");
...
void
L2Cache_Controller::ll_clearSharers(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:830: %s.\n", "assert failure");

}
#endif
;
(((*m_cache_entry_ptr).m_PriorSharers).addNetDest((*m_cache_entry_ptr).m_Sharers));
...
void
L2Cache_Controller::mm_markExclusive(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:838: %s.\n", "assert failure");
...
/** \brief set the exclusive owner */
void
L2Cache_Controller::mmu_markExclusiveFromUnblock(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:847: %s.\n", "assert failure");
...
void
L2Cache_Controller::zz_stallAndWaitL1RequestQueue(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::zn_recycleResponseNetwork(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
void
L2Cache_Controller::kd_wakeUpDependents(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
...
/** \brief 212 */
void
L2Cache_Controller::mtit_mtitocleannotice(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing mtit_mtitocleannotice\n");
    try {
       
    } catch (const RejectException & e) {
       fatal("Error in action L2Cache:mtit_mtitocleannotice: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}
...
void
L2Cache_Controller::evnt_evictNotice(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr, int core_id)//fanyao added core_id
{
    DPRINTF(RubyGenerated, "executing evnt_evictNotice\n");
    try {
       {
    std::shared_ptr<RequestMsg> out_msg = std::make_shared<RequestMsg>(clockEdge());
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:872: %s.\n", "assert failure");
    ...
    ((*m_L1RequestFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles((1))));
       ...
       fatal("Error in action L2Cache:evnt_evictNotice: "
             "executed a peek statement with the wrong message "
             "type specified. ");
    }
}
...
#ifndef NDEBUG
if (!((param_cache_entry != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:181: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:182: machineID: %s, requestor: %s, address: %#x\n", m_machineID, param_requestor, param_addr);
...
L2Cache_TBE* tbe
 = (((*m_TBEs_ptr)).lookup(param_addr));
    if ((tbe != NULL)) {
        DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:210: %s\n", (L2Cache_State_to_permission((*tbe).m_TBEState)));
    ...
    L2Cache_Entry* cache_entry
     = (getCacheEntry(param_addr));
        ...
        DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:220: %s\n", AccessPermission_NotPresent);
                            ...
                            if ((param_type == CoherenceRequestType_UPGRADE)) {
                                    if (((param_cache_entry != NULL) && (((*param_cache_entry).m_Sharers).isElement(param_requestor)))) {
                                        ...
                                        if ((param_type == CoherenceRequestType_PUTX)) {
                                                ...
                                                DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:275: address: %#x, Request Type: %s\n", param_addr, param_type);
                                                panic("Runtime Error at MESI_Two_Level-L2cache.sm:276: %s.\n", ("Invalid L1 forwarded request type"));
                                                ;
                                            }
                                        }
                                    }
...
#ifndef NDEBUG
if (!((param_cache_entry != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:285: %s.\n", "assert failure");
