...
(Tick curTime) : Message(curTime) {
    ...
    MemoryMsg(const Tick curTime, const Addr& local_addr, const MemoryRequestType& local_Type, const MachineID& local_Sender, const MachineID& local_OriginalRequestorMachId, const DataBlock& local_DataBlk, const MessageSizeType& local_MessageSize, const PrefetchBit& local_Prefetch, const bool& local_ReadX, const int& local_Acks)
        : Message(curTime)
    {
        m_addr = local_addr;
        m_Type = local_Type;
