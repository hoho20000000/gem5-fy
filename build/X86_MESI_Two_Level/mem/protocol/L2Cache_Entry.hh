...
()
        ...
        : AbstractCacheEntry(other)
    {
        ...
        m_PriorSharers = other.m_PriorSharers;
        m_Exclusive = other.m_Exclusive;
        m_DataBlk = other.m_DataBlk;
        m_Dirty = other.m_Dirty;
    }
    L2Cache_Entry(const L2Cache_State& local_CacheState, const NetDest& local_Sharers, const NetDest& local_PriorSharers, const MachineID& local_Exclusive, const DataBlock& local_DataBlk, const bool& local_Dirty)
        : AbstractCacheEntry()
    {
        m_CacheState = local_CacheState;
        m_Sharers = local_Sharers;
        m_PriorSharers = local_PriorSharers;
    ...
    /** \brief Const accessor method for PriorSharers field.
     *  \return PriorSharers field
     */
    const NetDest&
    getPriorSharers() const
    {
        return m_PriorSharers;
    }
    ...
    /** \brief Non-const accessor method for PriorSharers field.
     *  \return PriorSharers field
     */
    NetDest&
    getPriorSharers()
    ...
    /** \brief Mutator method for PriorSharers field */
    void
    setPriorSharers(const NetDest& local_PriorSharers)
    {
        m_PriorSharers = local_PriorSharers;
    }
  ...
  //private:
    ...
    NetDest m_Sharers;
    /** tracks prior L1 owners, used for Prefetch-Guard */
    NetDest m_PriorSharers;
