...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_X86TLB')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_X86TLB')
...
class X86ISA_COLONS_TLB(m5.internal.param_BaseTLB.BaseTLB):
...
class X86TLBParams(m5.internal.param_BaseTLB.BaseTLBParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def create(self):
        return _param_X86TLB.X86TLBParams_create(self)
