...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_SimpleExtLink')
...
class SimpleExtLink(m5.internal.param_BasicExtLink.BasicExtLink):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
SimpleExtLink_swigregister = _param_SimpleExtLink.SimpleExtLink_swigregister
SimpleExtLink_swigregister(SimpleExtLink)

class SimpleExtLinkParams(m5.internal.param_BasicExtLink.BasicExtLinkParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
SimpleExtLinkParams_swigregister = _param_SimpleExtLink.SimpleExtLinkParams_swigregister
SimpleExtLinkParams_swigregister(SimpleExtLinkParams)
