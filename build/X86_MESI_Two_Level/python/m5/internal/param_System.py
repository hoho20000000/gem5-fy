...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_System')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_System')
...
class SystemParams(m5.internal.param_MemObject.MemObjectParams):
    ...
    exit_on_work_items = _swig_property(_param_System.SystemParams_exit_on_work_items_get, _param_System.SystemParams_exit_on_work_items_set)
    ...
    multi_thread = _swig_property(_param_System.SystemParams_multi_thread_get, _param_System.SystemParams_multi_thread_set)
