...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_BaseCache')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_BaseCache')
...
class BaseCacheParams(m5.internal.param_MemObject.MemObjectParams):
    ...
    is_read_only = _swig_property(_param_BaseCache.BaseCacheParams_is_read_only_get, _param_BaseCache.BaseCacheParams_is_read_only_set)
