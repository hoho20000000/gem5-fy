...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_SimpleDisk')
    _param_SimpleDisk = swig_import_helper()
...
class SimpleDisk(m5.internal.param_SimObject.SimObject):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
SimpleDisk_swigregister = _param_SimpleDisk.SimpleDisk_swigregister
SimpleDisk_swigregister(SimpleDisk)

class SimpleDiskParams(m5.internal.param_SimObject.SimObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
SimpleDiskParams_swigregister = _param_SimpleDisk.SimpleDiskParams_swigregister
SimpleDiskParams_swigregister(SimpleDiskParams)
