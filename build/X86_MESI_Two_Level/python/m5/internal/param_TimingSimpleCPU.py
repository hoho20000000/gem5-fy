...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_TimingSimpleCPU')
...
import m5.internal.param_BaseSimpleCPU
...
class TimingSimpleCPU(m5.internal.param_BaseSimpleCPU.BaseSimpleCPU):
...
class TimingSimpleCPUParams(m5.internal.param_BaseSimpleCPU.BaseSimpleCPUParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
