...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_SimpleNetwork')
    _param_SimpleNetwork = swig_import_helper()
...
import m5.internal.MessageBuffer_vector
...
class SimpleNetwork(m5.internal.param_RubyNetwork.Network):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
SimpleNetwork_swigregister = _param_SimpleNetwork.SimpleNetwork_swigregister
SimpleNetwork_swigregister(SimpleNetwork)

class SimpleNetworkParams(m5.internal.param_RubyNetwork.RubyNetworkParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
SimpleNetworkParams_swigregister = _param_SimpleNetwork.SimpleNetworkParams_swigregister
SimpleNetworkParams_swigregister(SimpleNetworkParams)
