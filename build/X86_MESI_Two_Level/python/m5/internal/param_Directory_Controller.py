...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_Directory_Controller')
...
import m5.internal.param_RubyDirectoryMemory
...
class Directory_Controller(m5.internal.param_RubyController.AbstractController):
...
class Directory_ControllerParams(m5.internal.param_RubyController.RubyControllerParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def create(self):
        return _param_Directory_Controller.Directory_ControllerParams_create(self)
    ...
    requestToDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_requestToDir_get, _param_Directory_Controller.Directory_ControllerParams_requestToDir_set)
    responseFromDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_responseFromDir_get, _param_Directory_Controller.Directory_ControllerParams_responseFromDir_set)
    responseFromMemory = _swig_property(_param_Directory_Controller.Directory_ControllerParams_responseFromMemory_get, _param_Directory_Controller.Directory_ControllerParams_responseFromMemory_set)
    responseToDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_responseToDir_get, _param_Directory_Controller.Directory_ControllerParams_responseToDir_set)
    to_mem_ctrl_latency = _swig_property(_param_Directory_Controller.Directory_ControllerParams_to_mem_ctrl_latency_get, _param_Directory_Controller.Directory_ControllerParams_to_mem_ctrl_latency_set)
