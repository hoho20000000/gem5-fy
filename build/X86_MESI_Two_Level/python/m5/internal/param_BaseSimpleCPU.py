...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            return importlib.import_module('_param_BaseSimpleCPU')
    _param_BaseSimpleCPU = swig_import_helper()
...
class BaseSimpleCPU(m5.internal.param_BaseCPU.BaseCPU):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
BaseSimpleCPU_swigregister = _param_BaseSimpleCPU.BaseSimpleCPU_swigregister
BaseSimpleCPU_swigregister(BaseSimpleCPU)

class BaseSimpleCPUParams(m5.internal.param_BaseCPU.BaseCPUParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
BaseSimpleCPUParams_swigregister = _param_BaseSimpleCPU.BaseSimpleCPUParams_swigregister
BaseSimpleCPUParams_swigregister(BaseSimpleCPUParams)
