...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_InvalidateGenerator')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_InvalidateGenerator')
...
class InvalidateGeneratorParams(m5.internal.param_DirectedGenerator.DirectedGeneratorParams):
    ...
    def create(self):
        return _param_InvalidateGenerator.InvalidateGeneratorParams_create(self)
