...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_LinuxX86System')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_LinuxX86System')
...
class LinuxX86SystemParams(m5.internal.param_X86System.X86SystemParams):
    ...
    def create(self):
        return _param_LinuxX86System.LinuxX86SystemParams_create(self)
