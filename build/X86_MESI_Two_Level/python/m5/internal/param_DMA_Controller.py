...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_param_DMA_Controller')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_param_DMA_Controller')
...
class DMA_ControllerParams(m5.internal.param_RubyController.RubyControllerParams):
    ...
    mandatoryQueue = _swig_property(_param_DMA_Controller.DMA_ControllerParams_mandatoryQueue_get, _param_DMA_Controller.DMA_ControllerParams_mandatoryQueue_set)
    requestToDir = _swig_property(_param_DMA_Controller.DMA_ControllerParams_requestToDir_get, _param_DMA_Controller.DMA_ControllerParams_requestToDir_set)
    ...
    responseFromDir = _swig_property(_param_DMA_Controller.DMA_ControllerParams_responseFromDir_get, _param_DMA_Controller.DMA_ControllerParams_responseFromDir_set)
